...
$registry_class = 'registry_SynoGenerateDoc';
$registry_path = 'custom/Synolia/SynoGenerateDoc/service/registry.php';
$webservice_impl_class = 'SugarWebServiceImpl_SynoGenerateDoc';
$location = '/custom/Synolia/SynoGenerateDoc/service/soap.php';
require_once('custom/Synolia/SynoGenerateDoc/service/SugarWebServiceImpl.php');
require_once('custom/Synolia/SynoGenerateDoc/service/SoapError.php');
