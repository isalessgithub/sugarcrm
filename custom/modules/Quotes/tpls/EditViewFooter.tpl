...
{
    sqs_objects['EditView_atc_clients_quotes_1_name']['post_onblur_function'] = 'setClientAddress';
    sqs_objects['EditView_atc_clients_quotes_2_name']['post_onblur_function'] = 'setClientAddress';
