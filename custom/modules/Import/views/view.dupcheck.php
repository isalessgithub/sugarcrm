 ...
 * All Rights Reserved.
 ********************************************************************************/
require_once('modules/Import/views/view.dupcheck.php');

class CustomImportViewDupcheck extends ImportViewDupcheck
{
    ...
    protected function _getJS()
    {
        ...
        $dupe_indexes = $idc->getDuplicateCheckIndexes();
         ...
         $dupe_disabled =  array();
         $dupe_enabled =  array();
         $mapped_fields = array('full_name','full_name_account');
