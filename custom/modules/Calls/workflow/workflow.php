...
//END WFLOW PLUGINS
 ...
 if( (isset($focus->call_outcome_c) && $focus->call_outcome_c ==  'Left company')){ 
	...
	if (!isset($triggeredWorkflows['d46343ee_de2d_11e7_85f7_12f45cb4e5cd'])){
		$triggeredWorkflows['d46343ee_de2d_11e7_85f7_12f45cb4e5cd'] = true;
		 unset($alertshell_array); 
		 $action_meta_array['Calls0_action0']['trigger_id'] = 'd46343ee_de2d_11e7_85f7_12f45cb4e5cd'; 
