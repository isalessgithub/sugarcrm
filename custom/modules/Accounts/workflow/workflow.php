...
if(!empty($_SESSION["workflow_cron"]) && $_SESSION["workflow_cron"]=="Yes" &&
	...
	if (!isset($triggeredWorkflows['d4669274_de2d_11e7_b5ce_12f45cb4e5cd'])){
		$triggeredWorkflows['d4669274_de2d_11e7_b5ce_12f45cb4e5cd'] = true;
		 unset($alertshell_array); 
		 $action_meta_array['Accounts0_action0']['trigger_id'] = 'd4669274_de2d_11e7_b5ce_12f45cb4e5cd'; 
