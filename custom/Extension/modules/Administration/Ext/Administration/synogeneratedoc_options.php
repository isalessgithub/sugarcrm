...
if( empty($synolia_plugins_installed) ){
    ...
    $admin_option_defs['synogeneratedoc'] = array (
       'synolia',
      'LBL_SYNOGENERATEDOC_TITLE',
      'LBL_SYNOGENERATEDOC_INFOS',
      './index.php?module=Administration&action=synogeneratedoc_manage'
    );    
    ...
    $admin_group_header[$synolia_plugins_installed][3]['Administration']['synogeneratedoc'] = array (
        'synolia',
        'LBL_SYNOGENERATEDOC_TITLE',
        'LBL_SYNOGENERATEDOC_INFOS',
        './index.php?module=Administration&action=synogeneratedoc_manage'
