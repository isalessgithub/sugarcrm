<?php
$dictionary['Account']['fields']['log_call_c']['enforced'] = 'false';
$dictionary['Account']['fields']['log_call_c']['dependency'] = '';
$dictionary['Account']['fields']['log_call_c']['name'] = 'log_call_c';
$dictionary['Account']['fields']['log_call_c']['vname'] = 'LBL_LOG_CALL';
