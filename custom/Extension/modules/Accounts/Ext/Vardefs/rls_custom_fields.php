<?php $sugar_version = $GLOBALS['sugar_version']; $V128a45e9 = $GLOBALS['sugar_flavor']; if ($V128a45e9 == 'ENT') {
 ...
 || $V2af72f10[0] > 7) ) { $dictionary["Account"]["fields"]["rls_linkedin_url_c"]['type'] = 'Linkedinfield';
} else { $dictionary["Account"]["fields"]["rls_linkedin_url_c"]['function'] = array( 'name' => 'getLinkedinProfileHTML',
