...
class MS_PortalReportsAPI extends SugarApi
{
    ...
    {
        // send the report
        return $this->sendSnapshotReport($args['cp_user_id']);
    }
     ...
     * @throws MailerException
     */
    private function sendSnapshotReport($cp_user_id)
    {
        // generate the report's HTML (for passed portal user)
        $report = $this->generateReport($cp_user_id);
     ...
     * @return array
     */
    private function generateReport($cp_user_id)
    {
        ...
        $snapshot_data = $this->getSnapshotData($campaigns);
     ...
     * @return string
     */
    private function getSnapshotData($campaigns)
    {
