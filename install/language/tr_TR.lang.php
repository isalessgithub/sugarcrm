 ...
 ********************************************************************************/
  ...
  *********************************************************************************/
  /*********************************************************************************
  * $Header: install/language/tr_TR.lang.php, V_6.5.2 Mon 17/09/12 18:59:58 
  * Description : .
...
$mod_strings = array ( 
   ...
   'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Veritabanı Desteği bulunamadı. 
Lütfen aşağıda desteklenen Veritabanı türlerinden biri için gerekli sürücünün bulunduğundan emin olun: MySQL veya MS SQLServer. Php.ini içindeki ilgili eklentiyi aktive etmek, veya PHP versiyonuna göre tekrar derlemek gerekebilir. Lütfen Veritabanı Desteği Etkinleştirme ile ilgili daha fazla bilgi için PHP Kılavuzuna başvurun.' ,
   ...
   'ERR_CHECKSYS_MBSTRING' => 'Sugar uygulaması tarafından ihtiyaç duyulan Multibyte Strings PHP eki (mbstring) ile ilişkili fonksiyonlar bulunamadı.<br/><br/>
Genellikle mbstring modülü varsayılan olarak PHP içinde etkin olmayıp, PHP programı oluşturulurken --enable-mbstring seçeneği ile etkinleştirilmelidir. 
 Mbstring desteğini etkinleştirmek ile ilgili daha fazla bilgi için PHP Kılavuzuna bakınız.' ,
   ...
   'ERR_CHECKSYS_SESSION_SAVE_PATH_NOT_WRITABLE' => 'Php yapılandırma dosyanızdaki (php.ini) belirtilen session.save_path ayarı, yazılabilir olmayan bir klasöre işaret etmektedir. Lütfen dosyanızı yazılabilir hale getirmek için gerekli adımları adın.
<br> İşletim Sistemine bağlı olarak dosyanın izinlerini değiştirmek (chmod 766 komutunu çalıştırarak)
, ya da dosyanın üzerine sağ tıklayıp özelliklerinde sadece okunur seçeneğini kaldırmak zorunda olabilirsiniz.' ,
   'ERR_CHECKSYS_CONFIG_NOT_WRITABLE' => 'Config dosyası var ama yazılabilir değil. Lütfen dosyanızın yazılabilir hale getirmek için gerekli adımları atın.
 İşletim Sistemine bağlı olarak dosyanın izinlerini değiştirmek (chmod 766 komutunu çalıştırarak)
 ya da dosyanın üzerine sağ tıklayıp özelliklerine eriştikten sonra, sadece okunur seçeneğini kaldırmak zorunda olabilirsiniz. ' ,
   ...
   'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE' => 'Özel Dizin var ama yazılabilir değil. 
İşletim Sistemine bağlı olarak dizinin izinlerini değiştirmek (chmod 766)
 ya da üzerine sağ tıklayıp sadece okunur seçeneğini kaldırmak zorunda olabilirsiniz. 
 Lütfen dosyanızın yazılabilir hale getirmek için gerekli adımları atınız.' ,
   ...
   'ERR_DB_EXISTS_WITH_CONFIG' => 'Veritabanı konfigürasyon verisiyle birlikte zaten var.
 Seçilen veritabanıyla birlikte kurulumu çalıştırmak için, lütfen kurulumu tekrar çalıştırın: "Var olan SugarCRM tablolarını kaldırın ve tekrar oluşturun? " seçeneğini kabul edin. Versiyon yükseltme için Yönetici Konsolundaki Versiyon Yükseltme Sihirbazını kullanın. Lütfen <a href="http://www.sugarforge.org/content/downloads/" target="_new">burada</a> adresinde bulunan versiyon yükseltme dokümanını okuyun.' ,
   'ERR_DB_EXISTS' => 'Verilen Veritabanı ismi zaten var -- aynı isme sahip başka bir Veritabanı oluşturamazsınız.' ,
   'ERR_DB_EXISTS_PROCEED' => 'Veritabanı ismi zaten var. 
Aşağıdaki seçenekleriniz bulunmaktadır.<br>1. Geri butonuna basın ve yeni bir veritabanı ismi seçin
<br>2. Sonra butonuna tıklayarak devam edin. Ancak veritabanı üzerindeki var olan tüm tablolar silinecektir. <strong>Bu tablolarınızın ve verilerinizin anlamına yok olacağı anlamına gelir.</ strong>' ,
   ...
   'LBL_CHECKSYS_1' => 'SugarCRM kurulum işleminin doğru olarak tamamlanabilmesi için, aşağıda listelenen tüm kontrol öğelerinin yeşil olduğundan emin olun. Eğer herhangi bir yerde kırmızı varsa,
 bunları düzeltmek için gerekli adımları atın.<BR><BR>
 Kontroller hakkında yardım için almak için, lütfen 
<a href="http://www.sugarcrm.com/crm/installation" target="_blank">Sugar Wiki</a> sayfasını ziyaret edin.' ,
   'LBL_CHECKSYS_CACHE' => 'Yazılabilir Cache Alt-Dizinleri' ,
   'LBL_DROP_DB_CONFIRM' => 'Sağlanan Veritabanı İsmi zaten mevcut.<br> Aşağıdaki seçenekleriniz bulunmaktadır:<br>
1. İptal butonuna tıklayın ve yeni bir veritabanı ismi seçin ya da<br>
2 Kabul butonuna tıklayın ve devam edin. Mevcut veritabanındaki tüm tablolar silinir. <strong> Bu tüm tabloların ve önceden var olan verilerin yok olacağı anlamına gelmektedir.</ strong>' ,
   ...
   'LBL_PERFORM_CREATE_DEFAULT' => 'Varsayılan Sugar verisini oluşturuyor' ,
   ...
   'LBL_PRINT' => 'Yazdır' ,
   'LBL_REG_CONF_1' => 'SugarCRM ürün duyuruları, eğitim haberleri, özel teklifler ve özel etkinlik davetiyeleri almak için lütfen aşağıdaki kısa formu doldurunuz.
Toplanılan bilgileri satma, kiralama ya da üçüncü şahıslarla paylaşma gibi amacımız yoktur.' ,
   ...
   'LBL_REG_CONF_3' => 'Kayıt olduğunuz için teşekkür ederiz. SugarCRM&#39;e giriş için Son butonuna tıklayın. İlk seferinde, kullanıcı ismini " admin " kullanıcısını ve 
2. adımda girdiğiniz şifreyi kullanarak oturum açmanız gerekir.' ,
   'LBL_REG_TITLE' => 'Kayıt' ,
   ...
   'LBL_SITECFG_ANONSTATS_DIRECTIONS' => 'Seçildiyse, Sugar uygulaması kullanım ile ilgili istatistik bilgileri <b>isimsiz</b> olarak SugarCRM firmasına gönderecek.
Bu bilgiler, uygulamanın nasıl kullanıldığının daha iyi anlaşılmasına ve ürün geliştirme modelinde iyileştirmeler yapılmasına olanak sağlayacak.' ,
...
<br>' ,
   ...
   'advanced_password_forgot_password_email' => array (
      ...
      'txt_body' => '
Kısa süre önce, $contact_user_pwd_last_changed üzerinde hesap şifrenizi sıfırlama isteğinde bulundunuz.

Aşağıdaki adrese tıklayarak, şifrenizi sıfırlayabilirsiniz:
...
$contact_user_link_guid' ,
   ...
   'advanced_password_new_account_email' => array (
      ...
      'txt_body' => '
Aşağıda kullanıcı ismi ve geçici şifre bulunmaktadır:
Kullanıcı İsmi :  $contact_user_user_name
Şifre: $contact_user_user_hash

$config_site_url

Üstteki şifreyi kullanıp sisteme girdikten sonra, kendi seçtiğiniz bir parola ile sıfırlama gerekli olabilir.' ,
