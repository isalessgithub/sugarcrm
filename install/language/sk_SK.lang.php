...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Databázovú podporu sa nepodarilo nájsť. Overte, či máte potrebné ovládače pre jeden z nasledujúcich podporovaných typov databáz: MySQL alebo MS SQLServer. Možno bude nutné odstrániť komentáre rozšírení v súbore php.ini alebo prekompilovať so správnym binárnym súborom, a to v závislosti od verzie PHP. Ďalšie informácie o tom, ako povoliť databázovú podporu, nájdete v príručke k PHP.<br><br>Oracle a DB2 nie sú podporované databázy pre aplikáciu SugarCRM PRO. Zoznam podporovaných databáz a ďalšie informácie o platforme nájdete na adrese <a href="http://support.sugarcrm.com/05_Resources/03_Supported_Platforms/">http://support.sugarcrm.com/05_Resources/03_Supported_Platforms/</a>.',
