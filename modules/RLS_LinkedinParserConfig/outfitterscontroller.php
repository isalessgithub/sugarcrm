...
if($_REQUEST['method'] == 'validate') {
    OutfittersLicense1::validate();
} else if($_REQUEST['method'] == 'change') {
    OutfittersLicense1::change();
} else if($_REQUEST['method'] == 'add') {
    OutfittersLicense1::add();
    ...
    $validate_license = OutfittersLicense1::isValid($currentModule,$user_id,true);
    ...
    if($validate_license !== true) {
        ...
        $validated = OutfittersLicense1::doValidate($currentModule);
