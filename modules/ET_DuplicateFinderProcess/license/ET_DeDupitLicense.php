...
if(!class_exists('ET_DeDupitLicense')) 
{
    class ET_DeDupitLicense
    {
        /**
         ...
         */
        public static function isValid($thisModule='ET_DeDupit',$user_id=null,$force_validation=false)
        {
            if(empty($thisModule)) {
            ...
            require('modules/ET_DuplicateFinderProcess/license/config.php');
            ...
            $validated = ET_DeDupitLicense::doValidate($thisModule);
        ...
        public static function validate()
        {
            ...
            $validated = ET_DeDupitLicense::doValidate($currentModule,$_REQUEST['key']);
        ...
        public static function doValidate($thisModule,$key=null)
        {
            ...
            {
                $GLOBALS['log']->fatal('ET_DeDupitLicense::doValidate() failed: '.print_r($response,true));
            }
        ...
        public static function change()
        {
            ...
            {
                header('HTTP/1.1 400 Bad Request');
                $GLOBALS['log']->fatal('ET_DeDupitLicense::change() failed: '.print_r($response,true));
            } 
            else 
            {
                require_once('modules/Administration/Administration.php');
        ...
        public static function add()
        {
            ...
            $response = ET_DeDupitLicense::doValidate($currentModule);
