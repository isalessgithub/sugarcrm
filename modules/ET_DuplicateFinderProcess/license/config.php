...
$outfitters_config = array(
    'name' => 'ET_DeDupit', //The matches the id value in your manifest file. This allow the library to lookup addon version from upgrade_history, so you can see what version of addon your customers are using
    //TODO enter info from SO
    'shortname' => 'DeDupit', //The short name of the Add-on. e.g. For the url https://www.sugaroutfitters.com/addons/sugaroutfitters the shortname would be sugaroutfitters
    'public_key' => '49544e0fd79bfd19f20b020c18f0e1ca', //The public key associated with the group
