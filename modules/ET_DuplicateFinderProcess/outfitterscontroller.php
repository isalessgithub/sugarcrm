...
require_once('modules/'.$currentModule.'/license/ET_DeDupitLicense.php');

if($_REQUEST['method'] == 'validate') {
    ET_DeDupitLicense::validate();
} else if($_REQUEST['method'] == 'change') {
    ET_DeDupitLicense::change();
} else if($_REQUEST['method'] == 'add') {
    ET_DeDupitLicense::add();
    ...
    $validate_license = ET_DeDupitLicense::isValid($currentModule,$user_id,true);
    ...
    if($validate_license !== true) {
        ...
        $validated = ET_DeDupitLicense::doValidate($currentModule);
