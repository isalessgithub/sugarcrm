...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'กำหนดค่าว่าคุณต้องการจัดหมวดหมู่ {{forecastByModule}} อย่างไร <br><br>โปรดทราบว่าการตั้งค่าช่วงจะไม่สามารถเปลี่ยนแปลงได้หลังจากที่คอมมิตครั้งแรก สำหรับอินสแตนซ์ที่อัปเกรด การตั้งค่าช่วงจะถูกล็อคกับข้อมูลประมาณการที่มีอยู่<br><br>คุณสามารถเลือกหมวดหมู่ได้สองหรือสามหมวดหมู่ตามช่วงความน่าจะเป็น<br><br>ผู้ใช้สามารถเปลี่ยนสถานะรวม/ไม่รวมและหมวดหมู่ของ {{forecastByModule}} ด้วยตนเองจากเวิร์กชีทของตน',
