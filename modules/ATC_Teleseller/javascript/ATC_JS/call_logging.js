...
function LogCall(module, parent_record, history, phone_other, contact_name, account_name, contact_title, contact_address, account_data) {
    ...
    top += '<table>' +
        '<tr>' +
        '<td width="10%">Name:</td>' +
        '<td width="40%" style="padding-left:10px; background-color:LightGrey;">' + contact_name + '&nbsp;</td>' +
        '<td width="10%">Company:</td>' +
        '<td width="40%" style="padding-left:10px;background-color:LightGrey;">' + account_name + '&nbsp;</td></tr>' +
        '<tr>' +
        '<td width="10%">Title:</td>' +
        '<td width="40%" style="padding-left:10px; background-color:LightGrey;">' + contact_title + '&nbsp;</td>' +
        '<td width="10%">Address:</td>' +
        '<td width="40%" style="padding-left:10px;background-color:LightGrey;">' + contact_address + '&nbsp;</td></tr>' +
        '</table>';
    top += '<table>' +
        '<tr>' +
        ...
        '<td nowrap=""><input autocomplete="off" type="text" id="follow_date_date" value="" size="11" maxlength="10" title="" tabindex="0" onblur="combo_follow_date.update();" onchange="handleReminder();combo_follow_date.update();">    <span alt="Enter Date" style="position:relative; top:6px" border="0" id="follow_date_trigger" onclick="showDateDiv()" data-orig="jscalendar.gif" class="spr_980451b001c99954db1c26b8603af06a"><img src="themes/default/images/jscalendar.gif"></span></td><td nowrap=""><div id="follow_date_time_section"><span style="position:relative; top:6px;"><select class="datetimecombo_time" size="1" id="follow_date_hours" tabindex="0" onchange="SugarWidgetScheduler.update_time();combo_follow_date.update(); "><option></option><option value="01">01</option><option value="02">02</option><option value="03">03</option><option value="04">04</option><option value="05">05</option><option value="06">06</option><option value="07">07</option><option value="08">08</option><option value="09">09</option><option value="10">10</option><option value="11">11</option><option value="12">12</option></select>&nbsp;:&nbsp;<select class="datetimecombo_time" size="1" id="follow_date_minutes" tabindex="0" onchange="combo_follow_date.update();SugarWidgetScheduler.update_time(); "><option></option><option value="00">00</option><option value="15">15</option><option value="30">30</option><option value="45">45</option></select>&nbsp;<select class="datetimecombo_time" size="1" id="follow_date_meridiem" tabindex="0" onchange="combo_follow_date.update();SugarWidgetScheduler.update_time(); "><option></option><option value="am">am</option><option value="pm">pm</option></select></span></div>' +
    ...
    // parse the passed account data
    var account_data = JSON.parse(account_data);

    // mk: add company tech section
    top += '<br><h2>Company Tech</h2>' +
        '<table style="overflow: auto;">' +
        '<tr class="odd"><td valign="top" style = "text-align : left ! important;" width="20%" scope="row">Data Storage</td>' +
        '<td valign="top" style = "text-align : left ! important;" width="20%" scope="row">' + account_data.ct_storage_c + '</td></tr>' +

        '<tr class="odd"><td valign="top" style = "text-align : left ! important;" width="20%" scope="row">Security</td>' +
        '<td valign="top" style = "text-align : left ! important;" width="20%" scope="row">' + account_data.ct_security_c + '</td></tr>' +

        '<tr class="odd"><td valign="top" style = "text-align : left ! important;" width="20%" scope="row">Networking</td>' +
        '<td valign="top" style = "text-align : left ! important;" width="20%" scope="row">' + account_data.ct_networking_c + '</td></tr>' +

        '<tr class="odd"><td valign="top" style = "text-align : left ! important;" width="20%" scope="row">Hardware/OS</td>' +
        '<td valign="top" style = "text-align : left ! important;" width="20%" scope="row">' + account_data.ct_hardware_c + '</td></tr>'
    ;
...
function ManageAppointments(module, parent_record, email_address, contact_name, account_name) {
	...
	'<option label="Event Registration" value="Event Registration">Event Registration</option>' +
        ...
        '<td nowrap=""><input autocomplete="off" type="text" id="appointment_date_date" value="" size="11" maxlength="10" title="" tabindex="0" onblur="combo_appointment_date.update();" onchange="combo_appointment_date.update(); "><span alt="Enter Date" style="position:relative; top:6px" border="0" id="appointment_date_trigger" data-orig="jscalendar.gif" class="spr_980451b001c99954db1c26b8603af06a"><img src="themes/default/images/jscalendar.gif" alt="Enter Date" style="position:relative;" border="0" id="delete_me_c_trigger"></span>&nbsp;</td><td nowrap=""><div id="appointment_date_time_section"><span style="position:relative; top:6px;"><select class="datetimecombo_time" size="1" id="appointment_date_hours" tabindex="0" onchange="combo_appointment_date.update(); "><option></option><option value="01">01</option><option value="02">02</option><option value="03">03</option><option value="04">04</option><option value="05">05</option><option value="06">06</option><option value="07">07</option><option value="08">08</option><option value="09">09</option><option value="10">10</option><option value="11">11</option><option value="12">12</option></select>&nbsp;:&nbsp;<select class="datetimecombo_time" size="1" id="appointment_date_minutes" tabindex="0" onchange="combo_appointment_date.update(); "><option></option><option value="00">00</option><option value="15">15</option><option value="30">30</option><option value="45">45</option></select>&nbsp;<select class="datetimecombo_time" size="1" id="appointment_date_meridiem" tabindex="0" onchange="combo_appointment_date.update(); "><option></option><option value="am">am</option><option value="pm">pm</option></select></span></div>' +
...
//addToValidate('EditView',"appointment_date_date",'date',false,"appointment_date");
    ...
    $.ajax({
        data: {
            ...
            entryPoint: "get_appointments",
            contact_id: parent_record,
            target_list_id: target_list_id_val
        },
        dataType: "json",
        url: "index.php",
...
var createAppointment = function () {
    ...
    postData += '&reminder_checked=' + $("#ScheduleAppointmentForm").find("input[name=reminder_checked]").prop('checked');
    postData += '&reminder_time=' + $("#ScheduleAppointmentForm").find("select[name=reminder_time]").val();
