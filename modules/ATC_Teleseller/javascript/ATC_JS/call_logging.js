...
function LogCall(module,parent_record,history,phone_other,contact_name,account_name){
  ...
  top += '<table>' +
   ...
   '<td nowrap=""><input autocomplete="off" type="text" id="follow_date_date" value="" size="11" maxlength="10" title="" tabindex="0" onblur="combo_follow_date.update();" onchange="handleReminder();combo_follow_date.update();">    <span alt="Enter Date" style="position:relative; top:6px" border="0" id="follow_date_trigger" onclick="showDateDiv()" data-orig="jscalendar.gif" class="spr_980451b001c99954db1c26b8603af06a"><img src="themes/RacerX/images/jscalendar.png?v=EQAiSf9JbpeiAohtX0LXrA" alt="Enter Date" style="position:relative; top:6px" border="0" id="delete_me_c_trigger"></span>&nbsp;</td><td nowrap=""><div id="follow_date_time_section"><span style="position:relative; top:6px;"><select class="datetimecombo_time" size="1" id="follow_date_hours" tabindex="0" onchange="SugarWidgetScheduler.update_time();combo_follow_date.update(); "><option></option><option value="01">01</option><option value="02">02</option><option value="03">03</option><option value="04">04</option><option value="05">05</option><option value="06">06</option><option value="07">07</option><option value="08">08</option><option value="09">09</option><option value="10">10</option><option value="11">11</option><option value="12">12</option></select>&nbsp;:&nbsp;<select class="datetimecombo_time" size="1" id="follow_date_minutes" tabindex="0" onchange="combo_follow_date.update();SugarWidgetScheduler.update_time(); "><option></option><option value="00">00</option><option value="15">15</option><option value="30">30</option><option value="45">45</option></select>&nbsp;<select class="datetimecombo_time" size="1" id="follow_date_meridiem" tabindex="0" onchange="combo_follow_date.update();SugarWidgetScheduler.update_time(); "><option></option><option value="am">am</option><option value="pm">pm</option></select></span></div>' +
