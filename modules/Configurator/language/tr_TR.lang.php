 ...
 ********************************************************************************/
  ...
  *********************************************************************************/
  /*********************************************************************************
  * $Header: modules/Configurator/language/tr_TR.lang.php, V_6.5.2 Mon 17/09/12 18:59:58 
  * Description : .
...
<br>
PDF içinde yazı tipini gömmek  istemiyorsanız, üretilen PDF dosyası daha açık olacaktır, ama eğer okuyucu sistemi içindeki yazı tipi mevcut değil ise, bir ikame kullanılacaktır.
<br><br>
SugarCRM gereksinimlerine bir PDF yazı tipini eklemek için  TCPDF web sitesinin "DOCS" bölümünde yer alan TCPDF Yazı Tipleri dokümantasyonunun 1 ve 2 numaralı adımlarını takip edin <a href="http://www.tcpdf.org" target="_blank">TCPDF</a>.
<br><br> "DOWNLOAD" bölümüne TCPDF paketindeki yazı tipleri/birimler içindeki pfm2afm ve ttf2ufm birimleri kullanılabilir <a href="http://www.tcpdf.org" target="_blank">TCPDF</a>.
<br><br>
Aşağıdaki yazı tipi dosyasını ve 2 no&#39;lu adımda üretilen ölçü dosyasını yükle.' ,
   ...
   'LBL_WIZARD_WELCOME' => 'Sugar ı şimdi yapılandırmak, yerini tespit etmek ve markalamak için <b>İleri</b> tıklayınız. Sugar ı daha sonra yapılandırmak için <b>Geç</b> e tıklayın.' ,
