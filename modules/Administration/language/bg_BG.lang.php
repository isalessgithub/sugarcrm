...
$mod_strings = array (
  ...
  'LBL_FTS_DISABLED' => 'Пълнотекстовото търсене е забранено защото системата не може да се свърже с търсачката.',
  'LBL_FTS_HOST' => 'Хост',
  'LBL_FTS_HOST_HELP' => 'Enter the name of the host where the full text search engine resides.',
  'LBL_FTS_INDEXING_DONE' => 'Индексирането на информацията за Глобално търсене е приключено.',
