 ...
 * PLACE ANY CUSTOMIZATIONS IN jw_Senior_Contact
 */

require_once 'include/SugarObjects/templates/person/Person.php';

class jw_Senior_Contact_sugar extends Person {
    public $new_schema = true;
    public $module_dir = 'jw_Senior_Contact';
    public $object_name = 'jw_Senior_Contact';
    public $table_name = 'jw_senior_contact';
