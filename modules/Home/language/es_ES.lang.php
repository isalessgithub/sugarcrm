...
$mod_strings = array (
  ...
  'LBL_TOUR_BRAND_DESCRIPTION' => 'Su logotipo va aquí. Para más información ponga el ratón encima.',
  'LBL_TOUR_CUSTOM' => 'Aplicaciones Personalizadas',
  'LBL_TOUR_CUSTOM_DESCRIPTION' => 'Las integración personalizadas estarán aquí.',
  'LBL_TOUR_DONE' => '¡Realizado!',
  'LBL_TOUR_FEATURES' => '<ul style=""><li class="icon-ok">Nueva barra de navegación simplificado</li><li class="icon-ok">Nuevo Pie de Página Plegable</li><li class="icon-ok">Búsqueda Mejorada</li><li class="icon-ok">Acciones de menú actualizadas</li></ul><p>y mucho más!</p>',
  'LBL_TOUR_FOOTER' => 'Pie de Página Plegable',
  'LBL_TOUR_FOOTER_DESCRIPTION' => 'Fácil de expandir y contraer el pie de página.',
  'LBL_TOUR_HOME' => 'Icono de Inicio',
  'LBL_TOUR_HOME_DESCRIPTION' => 'Regrese rápidamente al panel de control de su Página de Inicio en un sólo click',
  'LBL_TOUR_MODULES' => 'Módulos',
  'LBL_TOUR_MODULES_DESCRIPTION' => 'Todos sun módulos importantes están aquí.',
  ...
  'LBL_TOUR_NOTIFICATIONS_DESCRIPTION' => 'Aquí estarán las notificaciones de la aplicación Sugar.',
  ...
  'LBL_TOUR_QUICKCREATE_DESCRIPTION' => 'Cree rápidamente registros sin perder su situación.',
  'LBL_TOUR_REFERENCE_1' => 'Usted siempre podrá hacer referencia a nuestro',
  'LBL_TOUR_REFERENCE_2' => 'a través del enlace "Soporte" bajo la pestaña de perfil.',
  'LBL_TOUR_SEARCH' => 'Búsqueda de Texto Completo',
  'LBL_TOUR_SEARCH_DESCRIPTION' => 'La búsqueda se ha mejorado.',
