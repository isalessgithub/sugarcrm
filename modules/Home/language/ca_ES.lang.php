...
$mod_strings = array (
  ...
  'LBL_TOMORROW' => 'Demà',
  'LBL_TOOLS' => 'Eines',
  'LBL_TOUR_BRAND' => 'La seva marca',
  'LBL_TOUR_BRAND_DESCRIPTION' => 'El seu logotip va aquí. Pot pasar el ratolí per sobre per obtenir més informació.',
  'LBL_TOUR_CUSTOM' => 'Aplicacions personalitzades',
  'LBL_TOUR_CUSTOM_DESCRIPTION' => 'Integracions personalitzades aniria aquí.',
  'LBL_TOUR_DONE' => 'Ja està!',
  'LBL_TOUR_FEATURES' => '<ul style=""><li class="icon-ok">Nova simplificada barra de navegació</li><li class="icon-ok">Nou peu de pàgina plegable</li><li class="icon-ok">Cerca millorada</li><li class="icon-ok">Accions actualitzat menú</li></ul><p>i molt més!</p>',
  'LBL_TOUR_FOOTER' => 'Peu plegable',
  'LBL_TOUR_FOOTER_DESCRIPTION' => 'Fàcil d&#39;expandir i plegar el peu de pàgina.',
  'LBL_TOUR_HOME' => 'Icona d&#39;inici',
  'LBL_TOUR_HOME_DESCRIPTION' => 'Ràpidament tornar al teu tauler d&#39;instruments, pàgina d&#39;inici en un sol clic.',
  'LBL_TOUR_MODULES' => 'Mòduls',
  'LBL_TOUR_MODULES_DESCRIPTION' => 'Tots els teus mòduls importants són aquí.',
  'LBL_TOUR_MORE' => 'Més mòduls',
  'LBL_TOUR_MORE_DESCRIPTION' => 'La resta dels mòduls son aquí.',
  'LBL_TOUR_NOTIFICATIONS' => 'Notificacions',
  'LBL_TOUR_NOTIFICATIONS_DESCRIPTION' => 'Notificacions de l&#39;aplicació de Sugar aniria aquí.',
  'LBL_TOUR_PROFILE' => 'Perfil',
  'LBL_TOUR_PROFILE_DESCRIPTION' => 'Perfil d&#39;accés, configuració i tancar la sessió.',
  'LBL_TOUR_QUICKCREATE' => 'Creació ràpida',
  'LBL_TOUR_QUICKCREATE_DESCRIPTION' => 'Crear ràpidament documents sense perdre el seu lloc.',
  'LBL_TOUR_REFERENCE_1' => 'Sempre es pot fer referència al nostre',
  'LBL_TOUR_REFERENCE_2' => 'a través de la "Ajuda" que apareix a la pestanya de perfil.',
  'LBL_TOUR_SEARCH' => 'Recerca de text complert',
  'LBL_TOUR_SEARCH_DESCRIPTION' => 'Cerca ara és molt millor.',
  'LBL_TOUR_VISIT' => 'Per obtenir més informació, si us plau visiti la nostra aplicació',
  'LBL_TOUR_WATCH' => 'Vegi les novetats de Sugar',
  'LBL_TOUR_WELCOME' => 'Benvingut a Sugar',
