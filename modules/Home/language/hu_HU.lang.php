...
$mod_strings = array (
  ...
  'LBL_TOMORROW' => 'Holnap',
  'LBL_TOOLS' => 'Eszközök',
  'LBL_TOUR_BRAND' => 'Az Ön márkajelzése',
  'LBL_TOUR_BRAND_DESCRIPTION' => 'Az Ön logója kerül ide. Kattintson a további információkért!',
  'LBL_TOUR_CUSTOM' => 'Egyéni applikációk',
  'LBL_TOUR_CUSTOM_DESCRIPTION' => 'Integráció a saját igényeknek megfelelően.',
  'LBL_TOUR_DONE' => 'Kész!',
  'LBL_TOUR_FEATURES' => '<ul style=""><li class="icon-ok">Új, egyszerűsített navigációs sáv</li><li class="icon-ok">Összezárható lábléc</li><li class="icon-ok">Még hatékonyabb keresés</li><li class="icon-ok">Frissített műveleti menüsor</li></ul><p>és még sokkal több minden!</p>',
  'LBL_TOUR_FOOTER' => 'Összezárható lábléc',
  'LBL_TOUR_FOOTER_DESCRIPTION' => 'Könnyen előhívható és összezárható lábléc.',
  'LBL_TOUR_HOME' => 'Kezdőlap ikon',
  'LBL_TOUR_HOME_DESCRIPTION' => 'Térjen vissza kezdőlapjára csupán egy kattintással!',
  'LBL_TOUR_MODULES' => 'Modulok',
  'LBL_TOUR_MODULES_DESCRIPTION' => 'Minden fontos modulja itt található.',
  'LBL_TOUR_MORE' => 'Még több modul',
  'LBL_TOUR_MORE_DESCRIPTION' => 'A többi modul itt található.',
  'LBL_TOUR_NOTIFICATIONS' => 'Értesítések',
  'LBL_TOUR_NOTIFICATIONS_DESCRIPTION' => 'Itt landolnak a Sugar értesítések.',
  'LBL_TOUR_PROFILE' => 'Profil',
  'LBL_TOUR_PROFILE_DESCRIPTION' => 'Hozzáférés a profil és egyéb beállításokhoz, kijelentkezés.',
  'LBL_TOUR_QUICKCREATE' => 'Gyors létrehozás',
  'LBL_TOUR_QUICKCREATE_DESCRIPTION' => 'Rekordok gyors létrehozása felesleges helyváltoztatás nélkül.',
  'LBL_TOUR_REFERENCE_1' => 'Nézzen utána az alábbi anyagnak:',
  'LBL_TOUR_REFERENCE_2' => 'a profil fül alján található "támogatás" linkre kattintva.',
  'LBL_TOUR_SEARCH' => 'Keresés a teljes szövegben',
  'LBL_TOUR_SEARCH_DESCRIPTION' => 'Még hatékonyabb keresés.',
  'LBL_TOUR_VISIT' => 'További információkért, kérem, nyissa meg az alkalmazást',
  'LBL_TOUR_WATCH' => 'Tekintse meg a Sugar újdonságait',
