...
$mod_strings = array (
  ...
  'LBL_TOMORROW' => 'Zítra',
  'LBL_TOOLS' => 'Nástroje',
  'LBL_TOUR_BRAND' => 'Vlastní brand',
  'LBL_TOUR_BRAND_DESCRIPTION' => 'Vaše logo umísněte zde. Přejedte kurzorem myši pro více informací.',
  'LBL_TOUR_CUSTOM' => 'Vlastní aplikace',
  'LBL_TOUR_CUSTOM_DESCRIPTION' => 'Vlastní intergace.',
  'LBL_TOUR_DONE' => 'Jste hotov!',
  'LBL_TOUR_FEATURES' => 'Zjednodušená navigační lišta<br />nová zasouvací patička<br />zlepšené vyhledávání<br />aktualizované menu akcí<br />a mnohem více!',
  'LBL_TOUR_FOOTER' => 'Zasouvací patička',
  'LBL_TOUR_FOOTER_DESCRIPTION' => 'Jednoduše rozviťe nebo zasuňte patičku.',
  'LBL_TOUR_HOME' => 'Ikona úvodní stránky',
  'LBL_TOUR_HOME_DESCRIPTION' => 'Návrat na úvodní stránku na jeden klik',
  'LBL_TOUR_MODULES' => 'moduly',
  'LBL_TOUR_MODULES_DESCRIPTION' => 'Všechny důležité moduly jsou zde.',
  'LBL_TOUR_MORE' => 'Více modulů',
  'LBL_TOUR_MORE_DESCRIPTION' => 'Zbývající moduly jsou zde.',
  'LBL_TOUR_NOTIFICATIONS' => 'Upozornění',
  'LBL_TOUR_NOTIFICATIONS_DESCRIPTION' => 'Sugar notifikace dojdou sem.',
  'LBL_TOUR_PROFILE' => 'Profil',
  'LBL_TOUR_PROFILE_DESCRIPTION' => 'Profil, nastavení a odhlášení.',
  'LBL_TOUR_QUICKCREATE' => 'Rychlé vytvoření',
  'LBL_TOUR_QUICKCREATE_DESCRIPTION' => 'Rychlé vytvoření záznamu bez ztráty umístnění.',
  'LBL_TOUR_REFERENCE_1' => 'Můzete kdykoliv poskytnout referenci pro naší',
  'LBL_TOUR_REFERENCE_2' => 'pomocí linku "Podpora" v profilu.',
  'LBL_TOUR_SEARCH' => 'Full-textové vyhledávání',
  'LBL_TOUR_SEARCH_DESCRIPTION' => 'Vyhledávání je mnohem efektivnější.',
  'LBL_TOUR_VISIT' => 'Pro více informací prosím otevřete naší aplikaci',
  'LBL_TOUR_WATCH' => 'Sledujte novinky v Sugar aplikaci.',
  'LBL_TOUR_WELCOME' => 'Vítejte v Sugar aplikaci',
