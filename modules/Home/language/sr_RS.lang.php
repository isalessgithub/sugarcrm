...
$mod_strings = array (
  ...
  'LBL_TOUR_BRAND_DESCRIPTION' => 'Vaš logo ide ovde. Pređite mišem za još informacija.',
  'LBL_TOUR_CUSTOM' => 'Sopstvene aplikacije',
  'LBL_TOUR_CUSTOM_DESCRIPTION' => 'Sopstvene integracije idu ovde',
  'LBL_TOUR_DONE' => 'Gotovi ste!',
  'LBL_TOUR_FEATURES' => '<ul style=""><br /><li class="icon-ok">Nova pojednotavljena navigacija</li><br /><li class="icon-ok">Novi futer koji se može sakriti</li><br /><li class="icon-ok">Poboljšana pretraga</li><br /><li class="icon-ok">Ažuriran meni sa akcijama</li><br /></ul><br /><p>i još mnogo toga!</p>',
  'LBL_TOUR_FOOTER' => 'Futer koji se može sakriti',
  'LBL_TOUR_FOOTER_DESCRIPTION' => 'Lako prikažite i sakrijte futer',
  'LBL_TOUR_HOME' => 'Ikona za početnu stranu',
  'LBL_TOUR_HOME_DESCRIPTION' => 'Brzo se vrati na svoju početnu stranu samo jednim klikom',
  'LBL_TOUR_MODULES' => 'Moduli',
  'LBL_TOUR_MODULES_DESCRIPTION' => 'Svi Vaši bitmi moduli su ovde.',
  'LBL_TOUR_MORE' => 'Još modula',
  'LBL_TOUR_MORE_DESCRIPTION' => 'Ostatak Vaših modula je ovde.',
  'LBL_TOUR_NOTIFICATIONS' => 'Obaveštenja',
  'LBL_TOUR_NOTIFICATIONS_DESCRIPTION' => 'Sugar notifikacije će ići ovde',
  'LBL_TOUR_PROFILE' => 'Profil',
  'LBL_TOUR_PROFILE_DESCRIPTION' => 'Pristupi profilu, podešavanjima i odjavi.',
  'LBL_TOUR_QUICKCREATE' => 'Brzo kreiranje',
  'LBL_TOUR_QUICKCREATE_DESCRIPTION' => 'Brzo kreirajte zapise bez gubljenja pozicije u aplikaciji',
  'LBL_TOUR_REFERENCE_1' => 'Uvek možete referencirati naš',
  'LBL_TOUR_REFERENCE_2' => 'kroz link "Podrška" ispod taba profila',
  'LBL_TOUR_SEARCH' => 'Pretraživanje celog teksta',
  'LBL_TOUR_SEARCH_DESCRIPTION' => 'Pretraga je upravo postala mnogo bolja',
  'LBL_TOUR_VISIT' => 'Za više informacija molimo posetite našu aplikaciju',
  'LBL_TOUR_WATCH' => 'Pogledajte šta je novo u Sugar-u',
