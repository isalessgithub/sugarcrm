...
$mod_strings = array (
  ...
  'LBL_DISPLAY_COLS_HELP_DESC' => '<b>Schritte um Anzeigespalten zu wählen:</b><br/><br/>1) Klicken Sie auf ein Modul im <b>Related Modules</b> Panel, welches Sie für Ihre Ausgabe verwenden möchten.  Standardmäßig wird das Primärmodul (oberstes) im Baum ausgewählt.<br/><br/>	Sie können auch Felder von einem Related modul duch Klicken auf das Modul wählen. Module die verwandt sind mit vandandten des Primärmoduls können auch gewählt werden. Das Modul, welches Sie wählen entscheidet, welche Felder im <b>Verfügbare Felder</b> Panel erscheinen.<br/><br/>	2) Klicken Sie auf das Feld im <b>Verfügbare Felder</b> Panel, um die Felddaten in Ihrem Report anzuzeigen.  Sie können nach Feldern mit der Textbox auch suchen.<br/><br/>	Sie können die reihenfolge durch Drag & Drop ändern.',
  ...
  'LBL_FILTERS_HELP_DESC' => '<b>Wie man Filter definiert:</b><br/><br/>1) Klicken Sie auf das Modul im <b>Related Modules</b> Panel, welches Sie für die Filterdefinition verwenden möchten. Standardmäßig wird das Primärmodul (oberstes) im Baum ausgewählt. <br/><br/>	Sie können ein related modul durch Klicken des Moduls auswählen. Expandieren Sie den Punkt um zusätzliche Verwandte Module aufzulisten. Das Modul, welches Sie wählen, bestimmt welche <b>Verfügbaren Felder <b> Sie für den Report haben.<br/><br/>	2) Klicken Sie auf ein Feld im <b>Verfügbare Felder <b>  Panel, um es Ihren Filtern hinzuzufügen. Sie können nach Feldern mit der Textbox auch suchen.<br/><br/>	Nach dem Auswählen einer beliebigen Anzahl an Feldern können Sie das ausgewählte Modul im<b>Related Modules</b> Panel ändern in dem Sie wieder eine beliebige Anzahl an Felder als Filter setzten können.<br/><br/>	3) Wählen Sie <b>UND</b> oder <b>ODER</b>, um zu bestimmen wie die Filter für den Report verwendet werden.<br/><br/>	4) [Optional] Klicken Sie auf <b>Filtergruppe hinzufügen</b> um Filtergruppen zu erstellen. Sie können unbegrenzt viele Filtergruppen erstellen und unbegrenzt viele Filter in einer Gruppe erstellen.<br/><br/>	5) [Optional] Wählen Sie die Laufzeit Option für einen Filter, um Benutzern den Zugriff auf den Filter zu erlauben um die Filter anzupassen während der Report betrachtet wird.',
  'LBL_FILTER_AND' => 'ALLE',
