...
class ATC_Clients_sugar extends Company {
    ...
    public $module_dir = 'ATC_Clients';
    public $object_name = 'ATC_Clients';
    public $table_name = 'atc_clients';
     ...
     * @deprecated
     */
    public function ATC_Clients_sugar(){
        $GLOBALS['log']->deprecated('Calls to ATC_Clients::ATC_Clients are deprecated.');
        self::__construct();
    }
