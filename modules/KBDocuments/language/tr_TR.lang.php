...
$mod_strings = array (
  ...
  'LBL_SYNTAX_CHEAT_SHEET' => '<B>Sorgu Sözdizimi Yardım:</b><P> <ol> <li>Artı işareti (+), sonuç mutlaka sorguyu "içermelidir" </li> <li>Eksi işareti (-), sonuç mutlaka sorguyu "içermemelidir". Eğer İçerilmemesi gereken kelimeler daha önceden belirtilmişse, eksi işaretini kullanmaya gerek yoktur.</li> <li>Çift tırnak içerisinde bulunan birden fazla kelimeler ("örnek1 örnek2"), tek bir sorgu olarak aranır. Tırnaklar mutlak surette bulunmalıdır, yoksa arama çalışmaz.<br> Tek tırnak (&#92;&#39;) ile olduğu gibi arama yapılır ve grup .</li></ol></p><p><b>Örnek:</b><br><br> "Sugar" veya "CRM" olan makaleler içinde "Bilgi Bankası" ve "güzel" kelimelerini içeren fakat "demo" veya "eski zaman" içermeyen bir arama için:<br>&nbsp;&nbsp;&nbsp;&nbsp;Sugar CRM +"Bilgi Bankası" + güzel -demo -"eski zaman"</p><br>          <p><b>Notlar:</b><br> <ol><li>Büyük küçük harf fark etmez.</li> <li>Boşluk ve virgüller, kabul edilen ayraçlardır.</li> <li> (-) veya (+) ile kelimenin arasına boşluk koymayın.</li></ol> </p>',
