...
$mod_strings = array (
  ...
  'LNK_ARCHIVED_EMAIL_LIST' => 'アーカイブ済み電子メール',
  'LNK_CALL_LIST' => '電話',
  ...
  'LBL_SEARCH_FOR' => '検索',
  'LBL_EMAIL_INBOUND_TYPE_HELP' => '<b>個人</b>: あなたがアクセス可能なメールアカウントです。このアカウントからはあなただけがメールの管理とインポートが可能です。<br><b>グループ</b>: 特定のチームのメンバーがアクセス可能なメールアカウントです。チームメンバーはメールの管理とインポートが可能です。<br><b>グループ - 自動インポート</b>: 特定のチームのメンバーがアクセス可能なメールアカウントです。電子メールは自動的にレコードとしてインポートされます。',
